    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                @endif
                <!--begin::Form-->
                <form action="{{ route('medcine.update', 'medcine') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline mb-3"
                                    ...
                                    style="background-image: url({{ asset($medcine->profile_img) }})">
                                    ...
                                    <label
                                        ...
                                        <!--begin::Inputs-->
                                        <input type="file" name="profile_img" accept="image/*,application/pdf"
                                            multiple>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <label for="kt_ecommerce_add_product_store_template" class="form-label">Select un
                                    spécialités</label>
                                ...
                                <select class="form-select mb-2 " name="specialties" data-placeholder="Select an option">
                                    @foreach ($specialties as $specialtie)
                                        <option value="{{ $specialtie->id }}"
                                            @if ($specialtie->id == $medcine->specialties) @selected(true) @endif>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Select store template-->
                                <label for="kt_ecommerce_add_product_store_template" class="form-label">Select la
                                    Nationalité</label>
                                <!--end::Select store template-->
                                <!--begin::Select2-->
                                <select class="form-select mb-2 " name="nationalite" data-placeholder="Select an option">
                                    <option value="Maroc" {{ $medcine->nationalite == 'Maroc' ? 'selected' : '' }}>Maroc
                                    </option>
                                    <option value="autre" {{ $medcine->nationalite == 'autre' ? 'selected' : '' }}>Autre
                                    </option>
                                </select>
                            </div>
                            <!--end::Card body-->
                                    ...
                                    <div class="card card-flush py-5 px-5">
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                    placeholder="" name="name" value="{{ $medcine->name }}">
                                                <!--end::Input-->
                                            ...
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Input-->
                                                <input type="text" class="form-control form-control-solid"
                                                    placeholder="" name="prenom" value="{{ $medcine->prenom }}">
                                                <!--end::Input-->
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                            <!--end::Col-->
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <input class="form-control form-control-solid" placeholder=""
                                                    name="email" value="{{ $medcine->email }}">
                                                <!--end::Input-->
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                            <!--end::Col-->
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid"
                                                    placeholder="" name="telephone" value="{{ $medcine->telephone }}">
                                                <!--end::Input-->
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Input-->
                                                <input type="text" class="form-control form-control-solid"
                                                    placeholder="" name="adresse" value="{{ $medcine->adresse }}">
                                                <!--end::Input-->
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                            <!--end::Col-->
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid"
                                                    placeholder="" name="ville" value="{{ $medcine->ville }}">
                                                <!--end::Input-->
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                            <!--end::Col-->
