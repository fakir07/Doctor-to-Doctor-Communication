            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Lists
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">medcine </small>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <a href="{{route('medcine.create')}}" class="btn  btn-primary" >
                                    ...
                                    <!--end::Svg Icon-->Ajouter une medcine
                                </a>
                            ...
                            <table id="kt_datatable_example_5"
                                ...
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        ...
                                        <th class="min-w-150px">Medcines</th>
                                        <th class="min-w-150px">spécialité</th>
                                        ...
                                        @foreach ($medcines as $medcine)
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center sorting_1">
                                                    ...
                                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                        <a>
                                                            <div class="symbol-label">
                                                                <img src="{{ asset($medcine->profile_img) }}" alt="{{$medcine->name}}" class="w-100">
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::User details-->
                                                    <div class="d-flex flex-column">
                                                        <a  class="text-gray-800 text-hover-primary mb-1">{{$medcine->name}}</a>
                                                        <span>{{$medcine->email}}</span>
                                                    </div>
                                                    <!--begin::User details-->
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        {{ $medcine->spécialité->specialty_name ? $medcine->spécialité->specialty_name : ' aucun Description ' }}
                                                    </a>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary d-block fs-6">
                                                        {{ $medcine->description ? $medcine->description : ' aucun Description ' }}
                                                    </a>
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content flex-shrink-0">
                                                        ...
                                                        <a data-bs-toggle="modal"
                                                            data-bs-target="#delete{{ $medcine->id }}"
